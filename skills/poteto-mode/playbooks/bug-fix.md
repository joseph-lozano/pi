...
3. Plan the fix. If it crosses a function boundary, `architect` first. Delegate implementation to a `profile: "poteto"`, `role: "bug-fix"` job with a specific scope; review the diff.
